              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="/admin/category/status/{{$category->id}}" class="btn btn-danger btn-sm"><i class="fa fa-thumbs-down"></i></a>
                    @else
                    <a href="/admin/category/status/{{$category->id}}" class="btn btn-info btn-sm"><i class="fa fa-thumbs-up"></i></a>
                    @endif
                  </td>
                  <td>
                      <a href="/admin/category/{{$category->id}}/edit" class="btn btn-info btn-flat btn-sm"> <i class="fa fa-edit"></i></a>
                      <a href="/admin/category/delete/{{$category->id}}" class="btn btn-danger btn-flat btn-sm"> <i class="fa fa-trash-o"></i></a>
                  </td>
                </tr>
                @endforeach
            </table>
