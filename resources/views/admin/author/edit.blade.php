                  ...
                  <input type="date" name="dob" class="form-control" id="dob" placeholder="Date of Birth" value="{{$author->dob}}">
                    ...
                    <div class="form-group">
                      ...
                      <select name="country" id="country" class="form-control select2" style="width: 100%;">
                        ...
                        <option value="pakistan"{{($author->country == "pakistan") ? 'selected' : null}}>Pakistan</option>
                        <option value="india" {{($author->country == "india") ? 'selected' : null}}>India</option>
                        <option value="sri lanka" {{($author->country == "siri lanka") ? 'selected' : null }}>Sri Lanka</option>
                      </select>
                    </div>
