...
<!-- Document Title -->
<title><?php echo $__env->yieldContent('page-title'); ?> | SmartBooks</title>
	    ...
	    <!-- Sub Footer -->
	   	<div class="sub-foorer">
	   		<div class="container">
	   			<div class="row">
		   			<div class="col-sm-6">
		   				<p>Copyright <i class="fa fa-copyright"></i> 2005-2016 <span class="theme-color">Staish Khalid</span> All Rights Reserved.</p>
		   			</div>
		   			<div class="col-sm-6">
...
</html<?php /**PATH D:\xampp\htdocs\smartbooks\resources\views/layout/master.blade.php ENDPATH**/ ?>