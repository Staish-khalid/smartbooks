    ...
    <div class="box-body">
      ...
      <div class="row"> 
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <img src="<?php echo e(url('uploads/No_Image_Available.jpg')); ?>" id="showImage" width="60" height="60" class="rounded avatar-lg" alt="No image found">
                </div>
              <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\smartbooks\resources\views/admin/author/create.blade.php ENDPATH**/ ?>